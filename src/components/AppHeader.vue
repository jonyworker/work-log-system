  ...
  <header class="mb-5 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
      <div>
        ...
        <h1 class="text-2xl font-bold text-slate-950">工作紀錄</h1>
      ...
      <div class="flex flex-wrap items-center gap-3">
        <div class="inline-flex rounded-xl bg-slate-100 p-1">
          <button
            ...
            :class="viewMode === 'day' ? 'bg-white text-slate-950 shadow-sm' : 'text-slate-500'"
          ...
          <button
            type="button"
            class="rounded-lg px-4 py-2 text-sm font-medium"
            :class="viewMode === 'week' ? 'bg-white text-slate-950 shadow-sm' : 'text-slate-500'"
          ...
          <button
            type="button"
            class="rounded-lg px-4 py-2 text-sm font-medium"
            :class="viewMode === 'month' ? 'bg-white text-slate-950 shadow-sm' : 'text-slate-500'"
        ...
        >
          ...
          <label class="flex items-center gap-2">
            <span class="text-xs text-slate-500">覆寫</span>
            ...
            <select
              ...
              @change="emit('update:selectedDayStatusOverride', $event.target.value)"
            >
              <option
